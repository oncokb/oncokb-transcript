...
const CurationHistoryTab = observer(
  ({ historyData, usersData, addUsersListener, historyTabStore, drugList, addDrugListListener }: ICurationHistoryTabProps) => {
...
const mapStoreToProps = ({ historyTabStore, firebaseUsersStore, firebaseDrugsStore }: IRootStore) => ({
