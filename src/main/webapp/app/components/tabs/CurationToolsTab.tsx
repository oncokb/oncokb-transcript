...
function CurationToolsTab({ addMetaListener, metaData, createMetaGene, deleteMetaGene, createGene, deleteGene }: StoreProps) {
...
export default componentInject(mapStoreToProps)(observer(CurationToolsTab));
