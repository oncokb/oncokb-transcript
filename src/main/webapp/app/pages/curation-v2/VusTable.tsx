...
import AddVusModalV2 from 'app/shared/modal/AddVusModalV2';
...
const VusTable = ({
  ...
  return (
    <>
      ...
      {showAddVusModal ? (
        <AddVusModalV2 hugoSymbol={hugoSymbol} vusList={vusData} onCancel={() => setShowAddVusModal(false)} onConfirm={handleAddVus} />
      ) : undefined}
    </>
  );
};
