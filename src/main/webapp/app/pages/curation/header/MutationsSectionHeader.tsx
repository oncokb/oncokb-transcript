    ...
    <div className={'d-flex align-items-center mb-2 mt-4'}>
      ...
      <div style={{ width: '100%' }} className="d-flex align-items-center justify-content-between mb-2">
        {mutationsAreFiltered ? (
          <span>{`Showing ${filteredMutationKeys.length} of ${Object.keys(mutations ?? {}).length} matching the search`}</span>
        ) : (
          <span />
        )}
        {Object.values(mutations ?? {}).length > 0 && isMutationListRendered && (
