...
export enum HISTORY_LOCATION_STRINGS {
  ...
  MONOALLELIC_MUTATION_SPECIFIC_PENETRANCE = 'Mutation Specific Penetrance, Monoallelic',
  BIALLELIC_MUTATION_SPECIFIC_PENETRANCE = 'Mutation Specific Penetrance, Biallelic',
  MOSAIC_MUTATION_SPECIFIC_PENETRANCE = 'Mutation Specific Penetrance, Mosaic',
