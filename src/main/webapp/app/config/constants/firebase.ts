...
export const INHERITANCE_MECHANISM_OPTIONS = [
  GERMLINE_INHERITANCE_MECHANISM.AUTOSOMAL_DOMINANT,
  GERMLINE_INHERITANCE_MECHANISM.AUTOSOMAL_RECESSIVE,
  GERMLINE_INHERITANCE_MECHANISM.X_LINKED_RECESSIVE,
];
...
export enum READABLE_FIELD {
  ...
  TUMOR_SPECIFIC_DRUG_DESCRIPTION = 'Tumor Specific Drug Description',
  ...
  INHERITANCE_MECHANISM = 'Inheritance Mechanism',
...
export const FIREBASE_KEY_TO_READABLE_FIELD: { [key: string]: READABLE_FIELD } = {
  ...
  description_addendums: READABLE_FIELD.TUMOR_SPECIFIC_DRUG_DESCRIPTION,
