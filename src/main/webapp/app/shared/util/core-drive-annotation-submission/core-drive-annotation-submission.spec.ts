...
describe('Drive annotation to submit to core', () => {
  describe('getGeneData', () => {
    test('exclude comments and include only reviewed content', () => {
      const geneData = getGeneData(mockGene, true, true, mockDrugList);
      expect(geneData).toEqual(expectedGeneDataNoCommentsAndReviewed);
    });
    test('exclude comments and include all content', () => {
      const geneData = getGeneData(mockGene, true, false, mockDrugList);
      expect(geneData).toEqual(expectedGeneDataNoCommentsAndAllContent);
    });
    test('include comments and only review content', () => {
      const geneData = getGeneData(mockGene, false, true, mockDrugList);
      expect(geneData).toEqual(expectedGeneDataCommentsAndReviewed);
    });
    test('include comments and all content', () => {
      const geneData = getGeneData(mockGene, false, false, mockDrugList);
      expect(geneData).toEqual(expectedGeneDataCommentsAndAllContent);
    });
  });
  describe('getVusData', () => {
    test('exclude comments', () => {
      const vusData = getVUSData(mockVus, true);
    ...
    test('With comments', () => {
      const vusData = getVUSData(mockVus, false);
      const expectedVusData = [
        {
          name: 'F888I',
          name_comments: [{ date: '1720646502304', userName: 'doej', email: '', content: 'comment', resolved: false }],
          time: { value: 1680011347000, by: { email: 'doej@gmail.com', name: 'John Doe' } },
        },
        {
          name: 'F595I',
          name_comments: [{ date: '1720646502305', userName: 'doej', email: '', content: 'comment', resolved: false }],
          time: { value: 1680011347329, by: { email: 'doej@gmail.com', name: 'John Doe' } },
        },
      ];
      expect(vusData).toEqual(expectedVusData);
    });
...
const mockGene = createMockGene({
  ...
  background_review: createMockReview({ updateTime: 1717770480000, updatedBy: 'John Doe' }),
    ...
    createMockMutation({
      ...
      tumors: [
        createMockTumor({
            ...
            createMockTi({
              ...
              treatments: [
                ...
                createMockTreatment({
                  ...
                  level: TX_LEVELS.LEVEL_1,
                  level_uuid: '8876d3de-9e1e-4d76-9909-3d6f1c30650c',
          ...
          summary_review: createMockReview({ updateTime: 1717770480000, updatedBy: 'John Doe' }),
...
const expectedGeneDataCommentsAndReviewed = {
  name: 'BRAF',
  name_comments: [],
  background: 'BRAF background',
  background_uuid: '16acb0f4-a01c-472e-b243-01560f92cf1e',
...
const expectedGeneDataCommentsAndAllContent = {
  name: 'BRAF',
  name_comments: [],
  background: 'BRAF background',
  background_uuid: '16acb0f4-a01c-472e-b243-01560f92cf1e',
