...
//           ],
//         } as Mutation;
//         expect(getMutationName(mutation.name, mutation.alterations), 'Mutation name should include both protein change and cdna when available').toEqual(
...
//           ],
//         } as Mutation;
//         expect(getMutationName(mutation.name, mutation.alterations), 'Mutation name should include protein change').toEqual('protein change');
