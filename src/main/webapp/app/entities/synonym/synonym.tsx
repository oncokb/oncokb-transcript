  ...
  return (
    <div>
      <h2 id="synonym-heading" data-cy="SynonymHeading">
        Synonyms
        <EntityActionButton className="ms-2" color="primary" entityType={ENTITY_TYPE.SYNONYM} entityAction={ENTITY_ACTION.ADD} />
      </h2>
      <div>
        {props.synonymList && (
          <OncoKBAsyncTable
...
export default connect<ISynonymProps, StoreProps>(mapStoreToProps)(Synonym);
