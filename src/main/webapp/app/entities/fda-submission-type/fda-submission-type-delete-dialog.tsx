  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="oncokbCurationApp.fdaSubmissionType.delete.question">
        Are you sure you want to delete this FDA Submission Type?
      </ModalBody>
      <ModalFooter>
...
export default connect<IFdaSubmissionTypeDeleteDialogProps, StoreProps>(mapStoreToProps)(FdaSubmissionTypeDeleteDialog);
