...
import { getEntities } from './gene-alias.reducer';
import { IGeneAlias } from 'app/shared/model/gene-alias.model';
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface IGeneAliasProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}
...
export const GeneAlias = (props: IGeneAliasProps) => {
  ...
  const { geneAliasList, match, loading } = props;
  return (
    <div>
...
const mapStateToProps = ({ geneAlias }: IRootState) => ({
  geneAliasList: geneAlias.entities,
  loading: geneAlias.loading,
});
...
export default connect(mapStateToProps, mapDispatchToProps)(GeneAlias);
