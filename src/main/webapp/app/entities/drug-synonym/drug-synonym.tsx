...
export interface IDrugSynonymProps extends StoreProps, RouteComponentProps<{ url: string }> {}

export const DrugSynonym = (props: IDrugSynonymProps) => {
  const drugSynonymList = props.drugSynonymList;
...
const mapStoreToProps = ({ drugSynonymStore }: IRootStore) => ({
  drugSynonymList: drugSynonymStore.entities,
  loading: drugSynonymStore.loading,
  getEntities: drugSynonymStore.getEntities,
});

type StoreProps = ReturnType<typeof mapStoreToProps>;

export default connect(mapStoreToProps)(DrugSynonym);
