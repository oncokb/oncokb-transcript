...
export const AlterationDeleteDialog = (props: IAlterationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="oncokbCurationApp.alteration.delete.question">Are you sure you want to delete this Alteration?</ModalBody>
      <ModalFooter>
...
export default connect<IAlterationDeleteDialogProps, StoreProps>(mapStoreToProps)(AlterationDeleteDialog);
