  ...
  return (
    <div>
      <h2 id="clinical-trial-heading" data-cy="ClinicalTrialHeading">
        Clinical Trials
        <EntityActionButton className="ms-2" color="primary" entityType={ENTITY_TYPE.CLINICAL_TRIAL} entityAction={ENTITY_ACTION.ADD} />
      </h2>
      <div>
...
export default connect<IClinicalTrialProps, StoreProps>(mapStoreToProps)(ClinicalTrial);
