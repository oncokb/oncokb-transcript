...
import org.mskcc.cbio.domain.Alignment;
...
public class AlignmentService {
    ...
    public AlignmentService(int gapPenalty, int vowelVowelMismatchPenalty, int consonantConsonantMismatchPenalty, int vowelConsonantMismatchPenalty, int numberNumberMismatchPenalty) {
