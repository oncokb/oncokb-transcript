...
import org.mskcc.oncokb.transcript.service.DrugService;
...
/**
 * REST controller for managing {@link org.mskcc.oncokb.transcript.domain.Drug}.
 */
@RestController
@RequestMapping("/api")
public class DrugResource {
     ...
     */
    @GetMapping("/drugs")
    public List<Drug> getAllDrugs(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
