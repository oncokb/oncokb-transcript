...
import org.mskcc.oncokb.transcript.service.GeneAliasService;
...
/**
 * REST controller for managing {@link org.mskcc.oncokb.transcript.domain.GeneAlias}.
 */
@RestController
@RequestMapping("/api")
public class GeneAliasResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/gene-aliases/{id}", consumes = "application/merge-patch+json")
