...
/**
 * Criteria class for the {@link org.mskcc.oncokb.curation.domain.FeatureFlag} entity. This class is used
 * in {@link org.mskcc.oncokb.curation.web.rest.FeatureFlagResource} to receive all the possible filtering options from
...
public class FeatureFlagCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, enabled, userId, distinct);
    }
