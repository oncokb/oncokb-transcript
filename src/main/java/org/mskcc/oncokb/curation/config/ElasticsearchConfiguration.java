...
import org.mskcc.oncokb.curation.converters.EntityToMapConverter;
import org.mskcc.oncokb.curation.converters.MapToEntityConverter;
...
public class ElasticsearchConfiguration extends ElasticsearchConfigurationSupport {
    ...
    private final EntityToMapConverter entityToMapConverter;
    private final MapToEntityConverter mapToEntityConverter;

    public ElasticsearchConfiguration(EntityToMapConverter entityToMapConverter, MapToEntityConverter mapToEntityConverter) {
        this.entityToMapConverter = entityToMapConverter;
        this.mapToEntityConverter = mapToEntityConverter;
    }
    ...
    public ElasticsearchCustomConversions elasticsearchCustomConversions() {
        return new ElasticsearchCustomConversions(
            Arrays.asList(
                ...
                entityToMapConverter,
                mapToEntityConverter
            )
        );
    }
