...
class DrugSynonymResourceIT {
    ...
    void createDrugSynonym() throws Exception {
        ...
        restDrugSynonymMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(drugSynonym)))
    ...
    void putWithMissingIdPathParamDrugSynonym() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restDrugSynonymMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(drugSynonym)))
    ...
    void patchWithMissingIdPathParamDrugSynonym() throws Exception {
        ...
        restDrugSynonymMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(drugSynonym))
            )
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteDrugSynonym() throws Exception {
        ...
        restDrugSynonymMockMvc
            .perform(delete(ENTITY_API_URL_ID, drugSynonym.getId()).accept(MediaType.APPLICATION_JSON))
