...
class GeneAliasResourceIT {
    ...
    void createGeneAlias() throws Exception {
        ...
        restGeneAliasMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(geneAlias)))
    ...
    void putWithMissingIdPathParamGeneAlias() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restGeneAliasMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(geneAlias)))
    ...
    void patchWithMissingIdPathParamGeneAlias() throws Exception {
        ...
        restGeneAliasMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(geneAlias))
            )
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteGeneAlias() throws Exception {
        ...
        restGeneAliasMockMvc
            .perform(delete(ENTITY_API_URL_ID, geneAlias.getId()).accept(MediaType.APPLICATION_JSON))
