...
class GeneResourceIT {
    ...
    void createGene() throws Exception {
        ...
        // Create the Gene
        restGeneMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(gene)))
    ...
    void putWithMissingIdPathParamGene() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restGeneMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(gene)))
    ...
    void patchWithMissingIdPathParamGene() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restGeneMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(gene)))
            .andExpect(status().isMethodNotAllowed());
